...
def main():
    ...
    # add discover weekly songs to discovery queue
    tracks =  get_playlist(access_token, DISCOVER_WEEKLY_ID)['tracks']['items']
    tracklist = []
    for item in tracks:
    ...
    if "snapshot_id" in response:
        print("Successfully added all Discover Weekly songs")
    else:
        print(response)
